...
function PendingOrders() {
  ...
  return (
    <>
    <ToastContainer />
      <PageTitle>Orders Pending Delivery</PageTitle>
          ...
          <TableBody>
            ...
            data.reverse().map((dt, i) => (
              <TableRow key={i}>
                ...
                <TableCell>
                  <span className="text-xs">Ksh. {Math.floor(dt.total_price).toLocaleString() }</span>
                </TableCell>
                <TableCell>
                  <span className="text-xs">{dt.deliveryLocation}</span>
                </TableCell>
                <TableCell>
                  <span className="text-xs">Ksh. { dt.delivery_cost.toLocaleString() }</span>
                </TableCell>
                <TableCell>
                  <span className="text-xs">Ksh. {(Math.floor(dt.total_price) +  dt.delivery_cost).toLocaleString()}</span>
                </TableCell>
                <TableCell>
